...
public class StartData {
    ...
    public void init() throws URISyntaxException, IOException {
        ...
        Product p3 = new Product("Phone Case", new byte[0], 10.0, "Protect your screen now!", 12, "20x50cm", 0, true, 0, 0, new ArrayList<>(), c5, new ArrayList<>(), s1);
        ...
        Product p5 = new Product("Earphones", new byte[0], 70.0, "High quality sound!", 12, "20x50cm", 0, true, 0, 0, new ArrayList<>(), c5, new ArrayList<>(), s1);
        p5 = productRepository.save(p5);
        Product p6 = new Product("USB cable", new byte[0], 20.0, "Works with any Android phonw!", 12, "20x50cm", 0, true, 0, 0, new ArrayList<>(), c5, new ArrayList<>(), s2);
